...
dimension = ['urn:ngsi-ld:DimensionProperty:dim-age', 'urn:ngsi-ld:DimensionProperty:dim-sex', 'urn:ngsi-ld:DimensionProperty:dim-lau']
attribute = "dimension"
value = dimension
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

attribute = ['urn:ngsi-ld:AttributeProperty:unitMeasure', 'urn:ngsi-ld:AttributeProperty:att-nuts3']
attribute = "attribute"
value = attribute
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
