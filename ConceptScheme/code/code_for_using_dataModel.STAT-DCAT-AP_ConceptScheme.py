...
hasTopConcept = ['urn:ngsi-ld:Concept:C', 'urn:ngsi-ld:Concept:I', 'urn:ngsi-ld:Concept:K', 'urn:ngsi-ld:Concept:M', 'urn:ngsi-ld:Concept:N', 'urn:ngsi-ld:Concept:R', 'urn:ngsi-ld:Concept:S', 'urn:ngsi-ld:Concept:T', 'urn:ngsi-ld:Concept:W', 'urn:ngsi-ld:Concept:X', 'urn:ngsi-ld:Concept:Y', 'urn:ngsi-ld:Concept:_Z']
attribute = "hasTopConcept"
value = hasTopConcept
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

prefLabel = {'en': 'Ajustement saisonnier', 'fr': 'Seasonal ajustments'}
attribute = "prefLabel"
value = prefLabel
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
